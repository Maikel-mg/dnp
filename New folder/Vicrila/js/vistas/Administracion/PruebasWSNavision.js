...
NavisioWSPage.prototype.eventos = function(){
    ...
    $('input#concatenar').on('change', function(){
        self.seleccionActual.Concatenar = ($(this).attr('checked') == 'checked');
        self.modificarFuenteNavision();
    });
...
NavisioWSPage.prototype.borrarFuenteNavision = function(){
    this.fuentesNavisionDS.Delete(this.seleccionActual.IdFuente);
};
...
NavisioWSPage.prototype.actualizarSeleccionFuente = function(){
    ...
    $('input#concatenar').attr('checked' , this.seleccionActual.Concatenar);
