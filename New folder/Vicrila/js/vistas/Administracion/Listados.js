var ListadosPage = function(){
    ...
    this.propiedadesCampo = new EditorCampoListado({contenedor:'#edicionCampo'});
    this.propiedadesCampo.onGuardar = function(){
        self.actualizarCampo();
    };
    ...
    this.camposModelosStore.onFiltrar = function(respuesta){
        if(respuesta.estado = 'OK')
        {
            ...
            else
            {
                ...
                self.propiedadesCampo.cargarComboCamposModelos(respuesta.datos);
            }
        }
        else
            alert(respuesta.mensaje);
...
ListadosPage.prototype.configurarEventosTabla = function(){
    ...
    this.tabla.onRowClicked = function(){
        var seleccion =  this.datos.find("IdCampoListado", this.getIdRegistroSeleccionada());

        app.log.debug('onRowClicked', seleccion);
...
ListadosPage.prototype.actualizarCampo = function(){
    var self = this;
    var actualizacion =  this.tabla.datos.find("IdCampoListado", this.tabla.getIdRegistroSeleccionada());
