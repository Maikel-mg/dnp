...
var ComponenteListado = function (opciones) {
    ...
    this.propiedades.campoId  = opciones.campoId;
...
ComponenteListado.prototype.suscripciones = function(){
...
ComponenteListado.prototype.refrescar = function(evento , eventArgs ){
    app.log.debug('Entidad refresco', eventArgs.entidad);
    if(eventArgs.entidad === undefined)
    {
